...
// import { useSeriesDetails, useSeriesTrailer } from "../hooks/useSeries";
// import SimilarContentCarousel from "../components/moviesDetails/SimilarContentCarousel";

// const SeriesDetails = () => {
//   const { id } = useParams<{ id: string }>();
//   const details = useSeriesDetails(id || "");
//   const seriesTrailer = useSeriesTrailer(id || "");
//   const trailer = seriesTrailer?.find(
