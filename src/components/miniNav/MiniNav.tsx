...
const MiniNav = () => {
  ...
  return (
    <div
      className={`fixed bottom-6 right-6 z-50 transition duration-1000 ${show ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"}`}
    >
        ...
        {isAuthorized ? (
          <>
            ...
            <button
              ...
              className="cursor-pointer flex flex-col items-center text-gray-300 hover:text-green-400 transition-all duration-200 group"
            >
