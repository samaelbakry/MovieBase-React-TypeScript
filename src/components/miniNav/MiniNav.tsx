...
const MiniNav = () => {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 transition duration-1000 ${show ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"}`}>
      <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-black/70 backdrop-blur-xl shadow-2xl border border-white/10">
        <button className="cursor-pointer flex flex-col items-center text-gray-300 hover:text-red-500 transition-all duration-200 group">
